...
declare function Manuscript({ text, columns, rows, showSpaceMarks, cursorCell, cursorSide, onCellClick, dblQuoteInit, sglQuoteInit, showRowNums, errorCells, pageIndex, }: ManuscriptProps): React.ReactElement;
