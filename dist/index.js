...
__export(index_exports, {
  ...
  ManuscriptDefault: () => Manuscript_default,
  OPEN_BRACKETS: () => OPEN_BRACKETS,
  PUNCT: () => PUNCT,
  QUOTE_CHARS: () => QUOTE_CHARS,
  SMALL_PUNCT: () => SMALL_PUNCT,
  advanceQuoteCount: () => advanceQuoteCount,
  buildCursorMaps: () => buildCursorMaps,
  buildFormattedCells: () => buildFormattedCells,
  canGroupWithNext: () => canGroupWithNext,
  isLineEndProhibited: () => isLineEndProhibited,
  isLineStartProhibited: () => isLineStartProhibited,
...
function Manuscript({
  ...
  const renderCell = (cell, index) => {
    ...
    if (typeof cell === "object" && cell !== null && "char" in cell) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          onClick: handleClick,
          children: [
            baseIsSmallPunct ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "punct-char", children: oc.char }) : oc.char,
            (opChar || oqChar) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "overflow-phantom-cell", children: [
              opChar && (isExclOverflow ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "phantom-excl", children: opChar }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "punct-char", children: opChar })),
    ...
    if (typeof cell === "object" && cell !== null && "ellipsis" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-ellipsis${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ellipsis-char", children: cell.ellipsis }) }, index);
    }
    if (typeof cell === "object" && cell !== null && "punctWithQuote" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `manuscript-cell cell-punct${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "punct-char", children: cell.punct }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "punct-char-close-quote", children: cell.quote })
      ] }, index);
    }
    if (typeof cell === "object" && cell !== null && "excl" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: cell.excl }, index);
    }
    if (typeof cell === "object" && cell !== null && "autoBlank" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-auto-blank${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick }, index);
    }
    if (typeof cell === "object" && cell !== null && "underflow" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-auto-blank${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick }, index);
    }
    if (typeof cell === "object" && cell !== null && "indent" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-indent${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: showSpaceMarks && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "indent-mark", children: "\u21B5" }) }, index);
    }
    if (typeof cell === "object" && cell !== null && "quoteChar" in cell) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell${qClass}${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: qSpanClass, children: cell.quoteChar }) }, index);
    }
    if (typeof cell === "object" && cell !== null && "bracketChar" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: cell.bracketChar }, index);
    }
    if (typeof cell === "object" && cell !== null && "double" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-double${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "double-char", children: cell.double }) }, index);
    }
    if (typeof cell === "object" && cell !== null && "single" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-alpha-single${cursorClass}${rowEndClass}${errorClass}`, onClick: handleClick, children: cell.single }, index);
    }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        onClick: handleClick,
        children: cell === " " ? showSpaceMarks ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "space-mark-v", children: "v" }) : "" : isSmallPunct ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "punct-char", children: cell }) : cell
      },
      index
    );
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "manuscript-wrapper", children: blocksToRender.map((blockCells, localIdx) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "manuscript-page-block", children: [
      showRowNums && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "manuscript-row-nums", children: Array.from({ length: rows }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "manuscript-row-num", children: i + 1 }, i)) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "manuscript-page-num", children: [
        "- ",
        actualPageIndex + 1,
        " -"
      ] })
