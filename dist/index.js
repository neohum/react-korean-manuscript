...
function Manuscript({
  ...
  const renderCell = (cell, index) => {
    ...
    if (typeof cell === "object" && cell !== null && "ellipsis" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-ellipsis${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ellipsis-char", children: cell.ellipsis }) }, index);
    }
    if (typeof cell === "object" && cell !== null && "punctWithQuote" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `manuscript-cell cell-punct${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: [
    ...
    if (typeof cell === "object" && cell !== null && "indent" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-indent${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: showSpaceMarks && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "indent-mark", children: "\u21B5" }) }, index);
    }
    ...
    if (typeof cell === "object" && cell !== null && "single" in cell) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `manuscript-cell cell-alpha-single${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: cell.single }, index);
    }
