...
function Manuscript({
  ...
  const renderCell = (cell, index) => {
    ...
    if (typeof cell === "object" && cell !== null && "excl" in cell) {
      ...
      return /* @__PURE__ */ jsxs("div", { className: `manuscript-cell cell-excl cell-overflow-punct${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: [
        exclCell.excl,
        (opChar || oqChar) && /* @__PURE__ */ jsxs("div", { className: "overflow-phantom-cell", children: [
          opChar && (EXCL_PUNCT_SET.has(opChar) ? /* @__PURE__ */ jsx("span", { className: "phantom-excl", children: opChar }) : /* @__PURE__ */ jsx("span", { className: "punct-char", children: opChar })),
          oqChar && /* @__PURE__ */ jsx("span", { className: "punct-char-open-quote", children: oqChar })
        ] })
      ] }, index);
    }
    ...
    if (typeof cell === "object" && cell !== null && "bracketChar" in cell) {
      ...
      return /* @__PURE__ */ jsx("div", { className: `manuscript-cell${bClass}${cursorClass}${rowEndClass}${errorClass}${hlClass}`, onClick: handleClick, children: /* @__PURE__ */ jsx("span", { className: bSpanClass, children: cell.bracketChar }) }, index);
    }
